...
Revision ID: ee2667d9d812
Revises: None
Create Date: 2016-03-10 15:07:55.335922

"""

# revision identifiers, used by Alembic.
revision = 'ee2667d9d812'
down_revision = None
...
def upgrade():
    ...
    sa.Column('module_letter', sa.String(length=15), nullable=True),
    ...
    sa.Column('st', sa.String(length=100), nullable=True),
    sa.Column('assets_no', sa.String(length=100), nullable=True),
    ...
    sa.Column('inner_ip', sa.String(length=30), nullable=True),
    ...
    sa.Column('chech_update_time', sa.DateTime(), nullable=True),
