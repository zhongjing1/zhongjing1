...
class CommonAction extends Action {
    function _initialize() {
        ...
        $this->assign("site",$site);
		 ...
		 $footlink=M('link')->where('catid=106')->select();
		 ...
		 $cate1=D("Category")->where(' ch=1 ')->select();
		 $cate2=D("Category")->where(' ch=2 ')->select();
		 $cate3=D("Category")->where(' ch=3 and mid=1 ')->select();
		 $cate4=D("Category")->where(' ch=4   and pid=0')->select();
		 $cate5=D("Category")->where(' ch=5 ')->select();
		 $cate10=D("Category")->where(' ch=10 ')->order('ordernum desc')->select();
		 $cate6=D("Category")->where(' ch=6 ')->order('ordernum desc')->select();

		 $cate11=D("Category")->where(' ch=11 ')->select();
