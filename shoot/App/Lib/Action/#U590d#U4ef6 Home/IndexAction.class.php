...
class IndexAction extends CommonAction {
 ...
 public function index() {
        ...
        if (method_exists($this, '_filter')) {
		 ...
		 $news=$this->article_mod->where('ch=10')->limit('0,5')->order('ordernum desc')->select();		 
		 
		 $huodong=$this->article_mod->where('ch=2  and catid=36 and thumb<>""')->limit('0,3')->order('ordernum desc')->select();		 
