...
class SinpageAction extends CommonAction {
    ...
    public function index(){
		...
		$catabout=D("Category")->where(' ch=4 and mid in (1,3,4) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
		...
		$catabout=D("Category")->where(' ch=6 and mid in (1,3,4) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
    ...
    public function partners(){
		...
		$catenews=D("Category")->where(' ch=5 and mid in (1,3,4,5) ')->select();
    ...
    public function link(){
		...
		$catabout=D("Category")->where(' ch=3 and mid in (1,3,4,5) ')->select();
        $this->assign("catabout",$catabout);
        $this->assign("id",$id);
        $this->assign("cattitle",$cat["title"]);
         $this->assign("seo",$seo);
  ...
  public function register(){
        ...
        $vo = $model->getById($id);
        $this->assign('row', $vo);
		$catabout=D("Category")->where(' ch=11 and mid in (1,3,4,5) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
  ...
  public function appointment(){
        ...
        $vo = $model->getById($id);
        $this->assign('row', $vo);
		$catenews=D("Category")->where(' ch=2 and mid in (1,3,4,5) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
 ...
 public function login(){
  ...
  public function business(){
		...
		$catabout=D("Category")->where(' ch=4 and mid in (1,3,4,5) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
  ...
  public function reg(){
        ...
        $vo = $model->getById($id);
        $this->assign('row', $vo);
		$catabout=D("Category")->where(' ch=5 and mid in (1,3,4,5) ')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
