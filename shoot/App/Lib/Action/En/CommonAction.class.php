...
class CommonAction extends Action {
    function _initialize() {
        ...
        $this->assign("site",$site);
		 ...
		 $ad_huandeng=M('link')->where('catid=262')->select();
		 $footlink=M('link')->where('catid=261')->limit("0,6")->select();
		 $sub_leftad=M('link')->where('catid=101')->select();
		 $kefuonline=M('link')->where('catid=107')->limit("0,15")->select();

		 $ad1=M('link')->where('catid=294')->limit("0,1")->select();
		 $ad2=M('link')->where('catid=295')->limit("0,1")->select();
		 $ad3=M('link')->where('catid=296')->limit("0,1")->select();
		 $ad4=M('link')->where('catid=297')->limit("0,1")->select();
		 $ad5=M('link')->where('catid=298')->limit("0,1")->select();
		 $ad6=M('link')->where('catid=299')->limit("0,1")->select();
		 $ad8=M('link')->where('catid=300')->limit("0,3")->select();
         $this->assign('ad1',$ad1);
         $this->assign('ad2',$ad2);
         $this->assign('ad3',$ad3);
         $this->assign('ad4',$ad4);
		 ...
		 $cate1=D("Category")->where(' ch=101 ')->order('ordernum asc')->select();
		 $cate2=D("Category")->where(' ch=102 ')->order('ordernum asc')->select();
		 $cate3=D("Category")->where(' ch=103 and mid=1 ')->order('ordernum asc')->select();
		 $cate4=D("Category")->where(' ch=104   and pid=0')->order('ordernum asc')->select();
		 $cate5=D("Category")->where(' ch=105 ')->order('ordernum asc')->select();
		 $cate10=D("Category")->where(' ch=110 ')->order('ordernum asc')->select();
		 $cate6=D("Category")->where(' ch=106 ')->order('ordernum asc')->select();

		 $cate11=D("Category")->where(' ch=111 ')->order('ordernum asc')->select();
