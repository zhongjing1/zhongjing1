...
class SinpageAction extends CommonAction {
    ...
    public function index(){
		...
		$catabout=D("Category")->where(' ch=1 and mid in (1,3,4) ')->order('ordernum asc')->select();
    ...
    public function yinsi(){
		...
		$catabout=D("Category")->where('  id in (280,281) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
		...
		$catabout=D("Category")->where(' ch=2 and mid in (1,3,4) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
		...
		$catabout=D("Category")->where(' ch=4 and mid in (1,3,4) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
    ...
    public function fuwu(){
		...
		$catabout=D("Category")->where(' ch=3 and mid in (1,3,4) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
		...
		$catabout=D("Category")->where(' ch=6 and mid in (1,3,4) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
  ...
  public function appointment(){
        ...
        $vo = $model->getById($id);
        $this->assign('row', $vo);
		$catenews=D("Category")->where(' ch=2 and mid in (1,3,4,5) ')->order('ordernum asc')->select();
        $site=D("config")->getField("varname,value");
        $seo['title']=$site["title"].'-'.$site["sitename"];
        $seo['keywords']=$site["keywords"];
        $seo['description']=$site["description"];
