...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =	array('header'=>'條記錄','prev'=>'Previous','next'=>'Next','first'=>'First page','last'=>'Last page','theme'=>' %totalRow% %header% %nowPage%/%totalPage% page %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
