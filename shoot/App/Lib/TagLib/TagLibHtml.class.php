...
class TagLibHtml extends TagLib{
    ...
    public function _list($attr,$content) {
        ...
        $id = !empty($tag['id'])?$tag['id']:'vo';  //定义数据查询的结果存放变量
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':
                $parseStr   =  '<script type="text/javascript" src="__ROOT__/Public/js/kindeditor/kindeditor-min.js"></script><script type="text/javascript" src="__ROOT__/Public/js/kindeditor/lang/zh_CN.js"></script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea><script type="text/javascript">  KindEditor.ready(function(K) {var editor = K.create("#'.$id.'",{ allowFileManager : true , filterMode : false}); });</script>';
