<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-01-06 10:36:55
         compiled from "/www/web/ten/public_html/views/activity/aoziweituan/chicheng/involved_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:627606261568c6f485db063-08741237%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '525eeb144972f603fdb8b19ca35a02d39ad98ae7' => 
    array (
      0 => '/www/web/ten/public_html/views/activity/aoziweituan/chicheng/involved_list.tpl',
      1 => 1452047759,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '627606261568c6f485db063-08741237',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_568c6f48701975_10664758',
  'variables' => 
  array (
    'index_dir' => 0,
    'company' => 0,
...
<?php if ($_valid && !is_callable('content_568c6f48701975_10664758')) {function content_568c6f48701975_10664758($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" >个人/团队报名</a></li>
            <li class="cur"><a href="<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved");?>
" >参与公司</a></li>
...
" >评论列表</a></li>
    ...
    <form action="<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved");?>
" method="post" enctype="multipart/form-data" name="search_text">
        <table class="table_search">
            <tr>
                <td>
                    <input type="text" class="input100" name="company" placeholder="公司名称" value="<?php echo $_smarty_tpl->tpl_vars['company']->value;?>
"/>
                    <input type="text" class="input100" name="project" placeholder="项目主题" value="<?php echo $_smarty_tpl->tpl_vars['project']->value;?>
"/>
                    <select name="status">
    ...
    <div style="float: left; margin:-26px 0 0 380px;">
        <input name="add" type="submit" class="button" value="添加" onclick="window.location.href='<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved_add");?>
'" />
    </div>
    </div>
    <!--批量操作-->
	<form action="<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved_batch");?>
...
" /></td>
                <td align="left">
                    <?php echo $_smarty_tpl->tpl_vars['key']->value['company'];?>
...
"/>
                ...
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['key']->value['projec'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['key']->value['money'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['key']->value['partnerrequire'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['key']->value['zan'];?>
</td>
                ...
                <td align="center">
                    <a href="<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved_update/".((string)$_smarty_tpl->tpl_vars['key']->value['id']));?>
">编辑</a>
 ...
 language="javascript">
    ...
    function get_delete(id){
        if(confirm('您确定要删除所选内容吗?\n\n注意：删除后不可恢复\！')){
            $.ajax({
                type:"POST",
                url: "<?php echo site_url(((string)$_smarty_tpl->tpl_vars['index_dir']->value)."/admin_involved_delete");?>
",
                data:"id="+id,
                dataType:"json",
