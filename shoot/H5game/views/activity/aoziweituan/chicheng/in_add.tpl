...
<table class="table_add">
    ...
    <tr>
        ...
        <td>
            ...
            <img src="" class="open_litpic" id="pic" <{if $id_update.image==''}>style="display: none"<{/if}>>
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;&nbsp;时间：<input name="addtime" class="input200" type="text" value="<{date('Y-m-d H:i:s',time())}>" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"/>
        </td>
    </tr>
</table>
</form>
