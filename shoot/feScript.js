...
$(".box.box1").tap(function(){window.open("http://jiajiabaoxian.com/piao/index.php/Home/Index/child.html")});
$(".box.box4").tap(function(){window.open("http://jiajiabaoxian.com/piao/index.php/Home/Index")});