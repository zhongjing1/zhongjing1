...
Calendar.prototype.draw = function() {
	...
	this.form.clearButton.onclick = function () {calendar.dateControl.value = "";if(calendar.dateControl.onchange)calendar.dateControl.onchange();calendar.hide();};
	...
	this.form.selectTodayButton.onclick = function () {
		...
		if(calendar.dateControl.onchange)calendar.dateControl.onchange()
		calendar.hide();
	};
};
...
Calendar.prototype.show = function (dateControl, popuControl,e) {
	...
	if (dateControl.value.length > 0){
        var dt=dateControl.value.toDate(this.patternDelimiter, this.string2DatePattern);
        if(dt)
        {
		    this.date  = dt;
		    this.year  = this.date.getFullYear();
...
document.writeln('<div id="__calendarPanel" style="position:absolute;left:0px;top:-220px; visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;">');
...
__ci.document.writeln('td.normal {background-color:#EFEFEF;cursor:default;}');
