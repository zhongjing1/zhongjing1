	...
	var hz6d_from_page = hz6d_getCookie("53kf_70772916_keyword");
	var kf_70772916_keyword_ok = hz6d_getCookie("kf_70772916_keyword_ok");
	if (kf_70772916_keyword_ok != 1)
	{
		hz6d_from_page = document.referrer;
	}
	hz6d_setCookie("53kf_70772916_keyword",hz6d_from_page);
	hz6d_setCookie("kf_70772916_keyword_ok",1);
	...
	function hasdoctype()
  {
	...
	function setIsinvited()
	{
		try
		{
			...
			if (acc_autotype == 3)
			{
				document.cookie = "onliner_zdfq70772916=" + onliner_zdfq;
			}
		}
		catch (e)
		{}
	}
	var onliner_zdfq = hz6d_getCookie("onliner_zdfq70772916"); // onliner_zdfq: 0.初始值 2.点击接受 3.点击拒绝 
	if (onliner_zdfq == "")
	{
		onliner_zdfq = 0;
		document.cookie = "onliner_zdfq70772916=" + onliner_zdfq;
	...
	// 加载ivt.php，即中间的接受邀请层 
	if (!hz6d$("ivt_script"))
		document.write("<scr"+"ipt src='http://www12.53kf.com/kf_ivt.php?arg=huaran&test_do=&style=1&isonline=1&kfonline=1&lang=zh-cn&resize=yes&charset=gbk&kflist=off&kf=&zdkf_type=1"+ hz6d_referer + hz6d_from_page + "&lytype=0&tpl_name=crystal_blue&tpl_width=703&tpl_height=473' type='text/javascript' id='ivt_script'></scr"+"ipt>");  
	...
	if (kf_script_num <= 1)
  {
      ...
      for (var i = 0; i < element_arrs.length; i++)
      {
        ...
        for (var j = 0;j < css_arr_3.length; j++)
        {
          ...
          if (css_pos == 8 && element_arr[css_pos].indexOf('http://') == -1)
            element_arr[css_pos] = "http://" + "www12.53kf.com" + "/" + element_arr[css_pos];
        ...
        else
        {
					switch (tmp_e_type)
          {
            ...
            case 'etel': click_str = 'window.open(\'http://chat.53kf.com/eht.php?company_id=70772916&style_id=103719566\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
            case 'qq':
							if (tmp_im_account != '' && tmp_im_account != '-'){
								if (tmp_im_account.toLowerCase().indexOf('biz') > -1){ //biz qq
									...
									link_str = 'http://www12.53kf.com/bizqq.php?qq=' + tmp_im_account + '&from=' + window.encodeURIComponent(window.location.href);
								} else{
	...
	}		if (typeof(kf_icons) == "undefined")
		{
			...
			function hishow(id, img_url)
			{
				...
				if (hz6d$(divname).style.display == "none")
				{
					...
					hz6d$("arrow" + id).src = "http://www12.53kf.com/" + img_url + "arrow1.gif";
				}
				else
				{
					hz6d$(divname).style.display = "none";
					hz6d$("arrow" + id).src = "http://www12.53kf.com/" + img_url + "arrow2.gif";
				}
			}
      ...
      function _getClickUrl()
      {
        ...
        return _click_str;
			...
			function _closeIcon()
			{
				...
				{
					str_onmove = "onmousemove='this.style.backgroundImage=\"url(http://www12.53kf.com/img/kflist/list_close_move.gif)\"' onmouseout='this.style.backgroundImage=\"url(http://www12.53kf.com/img/kflogo/close.gif)\"'";
				}
				if (0 == 1 || 70772916 == 600603 || 70772916 == 61393572 || 70772916 == 1413303 || 70772916 == 61389920 || 70772916 == 61420906 || 70772916 == 61578368)
				{
					if (2 == 1)
					{
						//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www12.53kf.com/img/kflogo/close.gif' "+str_onmove+" />";
						...
						return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='" + str_wh + "background:url(\"http://www12.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' " + str_onmove + " ></div>";
					}
					//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www12.53kf.com/img/kflogo/close.gif' />";
					return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='width:11px;height:11px;background:url(\"http://www12.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' ></div>";
				}
				return "";
			};
		...
		kf_icons[kf_icon_id].config["arg"] = "huaran";
    ...
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_on_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,110,160,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u5728\u7ebf\u56fe\u6807,chat,110,160,0,0,2,http:\/\/www12.53kf.com\/img\/kflogo\/yellow.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_off_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,110,160,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u79bb\u7ebf\u56fe\u6807,chat,110,160,0,0,2,http:\/\/www12.53kf.com\/img\/kflogo\/yellow_off.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
		kf_icons[kf_icon_id].config["img_on"] = "http://www12.53kf.com/img/kflogo/yellow.gif";
		kf_icons[kf_icon_id].config["img_off"] = "http://www12.53kf.com/img/kflogo/yellow_off.gif";
		kf_icons[kf_icon_id].config["height"] = "160";
		kf_icons[kf_icon_id].config["width"] = "110";
		...
		var hz6d_zdyurl = "?arg=huaran&style=1&kflist=off&kf=&zdkf_type=1&language=zh-cn&charset=gbk&lytype=0&referer={hz6d_referer}{hz6d_keyword}&tpl=crystal_blue";
		...
		kf_icons[kf_icon_id].config["server_path"] = "http://www12.53kf.com";
		...
		document.write("<scr"+"ipt src='http://www12.53kf.com/stat.php?com_id=70772916" + hz6d_referer + hz6d_from_page + "' type='text/javascript' id='stat_script'></scr"+"ipt>");